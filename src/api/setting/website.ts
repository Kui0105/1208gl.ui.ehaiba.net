...
export function getPriceInfo() {
    return request.get({ url: '/setting.web.web_setting/getPriceInfo' })
}
// 设置工单费用配置
export function setPriceInfo(params: any) {
    return request.post({ url: '/setting.web.web_setting/setPriceInfo', params })
}